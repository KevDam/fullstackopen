...
describe('favorite blog', () => {
    ...
    test('in list with many blogs, return blog with most likes', () => {
        ...
        const actualResult = listHelper.favoriteBlog(listWithManyBlogs)
...
describe('most blogs', () => {
    ...
    test('in list with many blogs, return author with most blogs', () => {
        ...
        const actualResult = listHelper.mostBlogs(listWithManyBlogs)
...
describe('most likes', () => {
    ...
    test('in list with many blogs, return author with most likes', () => {
        ...
        const actualResult = listHelper.mostLikes(listWithManyBlogs)
